# BuildHub — Foundations (v8) · справочник для Claude Code

> Маркетплейс стройматериалов (Армения). Этот файл — постоянный справочник: архитектура, конвенции, бизнес-правила, модель данных, настройки. План работ — в `buildhub_stages_v8.md` (стейджами). Foundations скармливается агенту один раз; затем идём по стейджам.
