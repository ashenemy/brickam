...
export const loadConfig = (options: LoadConfigOptions = {}): AppConfig => {
    ...
    const candidate: Record<string, unknown> = {
        ...
        secrets: {
            ...
            arcaGatewayUrl: env['ARCA_GATEWAY_URL'] || undefined,
            arcaUsername: env['ARCA_USERNAME'] || undefined,
            arcaPassword: env['ARCA_PASSWORD'] || undefined,
            idramGatewayUrl: env['IDRAM_GATEWAY_URL'] || undefined,
            idramRecAccount: env['IDRAM_REC_ACCOUNT'] || undefined,
            idramSecretKey: env['IDRAM_SECRET_KEY'] || undefined,
            emailFrom: env['EMAIL_FROM'] || undefined,
            sesRegion: env['SES_REGION'] || undefined,
