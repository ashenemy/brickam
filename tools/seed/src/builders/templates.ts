...
const TEMPLATES: TemplateSeed[] = [
    {
        ...
        content: {
            hy: 'BuildHub. Ձեր հաստատման կոդը՝ {{code}}: Մի՛ կիսվեք այն ոչ ոքի հետ:',
            ru: 'BuildHub. Ваш код подтверждения: {{code}}. Никому его не сообщайте.',
            en: 'BuildHub. Your verification code: {{code}}. Do not share it.',
        },
        variables: ['code'],
    },
    {
        ...
        content: {
            hy: 'Բարի գալուստ BuildHub, {{name}}: Շնորհակալություն գրանցման համար:',
            ru: 'Добро пожаловать в BuildHub, {{name}}! Спасибо за регистрацию.',
            en: 'Welcome to BuildHub, {{name}}! Thanks for signing up.',
        },
        variables: ['name'],
    },
    {
        ...
        subject: {
            hy: 'Բարի գալուստ BuildHub',
            ru: 'Добро пожаловать в BuildHub',
            en: 'Welcome to BuildHub',
        },
        content: {
            hy: 'Ողջույն, {{name}}: Շնորհակալ ենք BuildHub-ին միանալու համար:',
            ru: 'Здравствуйте, {{name}}! Спасибо, что присоединились к BuildHub.',
            en: 'Hello, {{name}}! Thank you for joining BuildHub.',
        },
        variables: ['name'],
    },
    {
    ...
    },
    {
        ...
        content: {
            hy: 'BuildHub: պատվեր №{{orderNumber}} ընդունված է, {{total}} AMD:',
            ru: 'BuildHub: заказ №{{orderNumber}} принят, {{total}} AMD.',
            en: 'BuildHub: order #{{orderNumber}} accepted, {{total}} AMD.',
        },
        variables: ['orderNumber', 'total'],
    },
    {
        ...
        content: {
            hy: 'BuildHub — շինանյութերի մարկետփլեյս Հայաստանում:',
            ru: 'BuildHub — маркетплейс строительных материалов в Армении.',
            en: 'BuildHub is a construction materials marketplace in Armenia.',
        },
        variables: [],
    },
    {
